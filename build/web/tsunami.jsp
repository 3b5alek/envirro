...
<body>
    ...
    <main class="disaster-page">
        <h1 class="disaster-title">Tsunami Disaster Reports</h1>
        ...
        <%
            ...
            try {
                ...
                // --- SQL query for tsunami reports ---
                String query = "SELECT scientistName, headerName, reportText FROM Reports WHERE published = TRUE AND disasterType = 'tsunami'";
        ...
        <div class="report-table-container">
            <table class="styled-report-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px;">No published tsunami reports found.</td>
                    </tr>
                    <%
                        }
                    %>
        ...
        <%
                ...
                System.err.println("SQL Error in tsunami.jsp: " + sqle.getMessage());
        ...
        <%
                ...
                System.err.println("General Error in tsunami.jsp: " + e.getMessage());
                e.printStackTrace();
        %>
        ...
        <div class="button-container">
            <a href="tsunami.html" class="view-reports-btn">Back to Tsunami Information</a>
        </div>
    </main>
