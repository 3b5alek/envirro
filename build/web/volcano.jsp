...
<body>
    ...
    <main class="disaster-page">
        <h1 class="disaster-title">Volcano Disaster Reports</h1>
        ...
        <%
            ...
            try {
                ...
                // --- SQL query for volcano reports ---
                String query = "SELECT scientistName, headerName, reportText FROM Reports WHERE published = TRUE AND disasterType = 'volcano'";
        ...
        <div class="report-table-container">
            <table class="styled-report-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px;">No published volcano reports found.</td>
                    </tr>
                    <%
                        }
                    %>
        ...
        <%
                ...
                System.err.println("SQL Error in volcano.jsp: " + sqle.getMessage());
        ...
        <%
                ...
                System.err.println("General Error in volcano.jsp: " + e.getMessage());
                e.printStackTrace();
        %>
        ...
        <div class="button-container">
            <a href="volacano.html" class="view-reports-btn">Back to Volcano Information</a>
        </div>
    </main>
