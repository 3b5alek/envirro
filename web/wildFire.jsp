...
<body>
    ...
    <main class="disaster-page">
        <h1 class="disaster-title">Wildfire Disaster Reports</h1>
        ...
        <%
            ...
            try {
                ...
                // --- SQL query for wildfire reports ---
                String query = "SELECT scientistName, headerName, reportText FROM Reports WHERE published = TRUE AND disasterType = 'wildFire'"; // Or 'wildfire'?
        ...
        <div class="report-table-container">
            <table class="styled-report-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px;">No published wildfire reports found.</td>
                    </tr>
                    <%
                        }
                    %>
        ...
        <%
                ...
                System.err.println("SQL Error in wildfire.jsp: " + sqle.getMessage());
        ...
        <%
                ...
                System.err.println("General Error in wildfire.jsp: " + e.getMessage());
                e.printStackTrace();
        %>
        ...
        <div class="button-container">
            <a href="wildFire.html" class="view-reports-btn">Back to Wildfire Information</a>
        </div>
    </main>
