...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><a href="welcome.html" class="nav-btn">Back to Menu</a></li>
        </ul>
    </nav>

    <main class="disaster-page">
        <h1 class="disaster-title">Asteroid Disaster Reports</h1>
        ...
        <%
            ...
            try {
                ...
                // --- Corrected the query's disasterType value assuming 'asteroids' is correct ---
                String query = "SELECT scientistName, headerName, reportText FROM Reports WHERE published = TRUE AND disasterType = 'asteroids'";
        ...
        <div class="report-table-container">
            <table class="styled-report-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px;">No published asteroid reports found.</td>
                    </tr>
                    <%
                        }
                    %>
        ...
        <%
                ...
                System.err.println("SQL Error in asteroids.jsp: " + sqle.getMessage());
        ...
        <%
                ...
                System.err.println("General Error in asteroids.jsp: " + e.getMessage());
                e.printStackTrace();
        %>
        ...
        <div class="button-container">
            <a href="astroids.html" class="view-reports-btn">Back to Asteroid Information</a>
        </div>
    </main>
</body>
</html>
