...
<body>
    ...
    <main class="disaster-page">
        <h1 class="disaster-title">Radiation Disaster Reports</h1>
        ...
        <%
            ...
            try {
                ...
                // --- SQL query for radiation reports ---
                String query = "SELECT scientistName, headerName, reportText FROM Reports WHERE published = TRUE AND disasterType = 'radiation'";
        ...
        <div class="report-table-container">
            <table class="styled-report-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px;">No published radiation reports found.</td>
                    </tr>
                    <%
                        }
                    %>
        ...
        <%
                ...
                System.err.println("SQL Error in radiation.jsp: " + sqle.getMessage());
        ...
        <%
                ...
                System.err.println("General Error in radiation.jsp: " + e.getMessage());
                e.printStackTrace();
        %>
        ...
        <div class="button-container">
            <a href="radiation.html" class="view-reports-btn">Back to Radiation Information</a>
        </div>
    </main>
