...
public class SignupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String password = request.getParameter("password"); // NOTE: Hash this in production!
        String role = "user";
        ...
        if (fname == null || fname.trim().isEmpty() ||
            ...
            try (Connection conn = DBInitialization.getConnection();
                ...
                ps.setString(4, password); // TODO: Use BCrypt to hash password
                ps.setString(5, role);

                int rows = ps.executeUpdate();
                if (rows > 0) {
                    redirectURL = "index.html"; // Redirect to login page
                } else {
